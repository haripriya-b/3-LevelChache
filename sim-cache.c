...
/*  Added/ Modified  */
	...
	/* l2 data cache l2 block miss handler function */
	static unsigned int			/* latency of block access */
...
/*  Added/ Modified  */
	...
	/* l2 inst cache l2 block miss handler function */
	static unsigned int			/* latency of block access */
...
"information is generated.\n"
  ...
  opt_reg_string(odb, "-cache:dl1",
		 ...
		 &cache_dl1_opt, "dl1:512:32:2:l", /* print */TRUE, NULL);
  opt_reg_note(odb,
...
/*  Added/ Modified  */
	  ...
	  opt_reg_string(odb, "-cache:dl3",
			 ...
			 &cache_dl3_opt, "ul3:4096:128:8:l", /* print */TRUE, NULL);
	  opt_reg_string(odb, "-cache:il1",
			 "l1 inst cache config, i.e., {<config>|dl1|dl2|none}",
			 &cache_il1_opt, "il1:512:32:2:l", /* print */TRUE, NULL);
	  opt_reg_note(odb,
...
/*  Added/ Modified  */
	  ...
	  opt_reg_flag(odb, "-third", "users choice",
		       &third, /* default */FALSE, /* print */TRUE, NULL);
...
/*  Added/ Modified  */
			  ...
			  int argc, char **argv)	/* command line arguments */
	{
	  ...
	  if (!mystricmp(cache_dl1_opt, "none"))
		...
		fatal("the l1 and l2 data caches must defined if the l3 cache is defined");
	      cache_dl3 = NULL;
	    }
	  else /* dl1 is defined */
	    {
	  ...
	  if (!mystricmp(cache_il1_opt, "none"))
		...
		fatal("the l1 and l2 inst caches must defined if the l3 cache is defined");
	      cache_il3 = NULL;
